...
class signModelForm(forms.ModelForm):
    class Meta:
        ...
        fields = '__all__'
        widgets = {
            'account': forms.TextInput(attrs={'class': 'form-control', 'style': 'width:400px', "placeholder": "含大小寫英文數字，最多10位"}),
            ...
            'email': forms.TextInput(attrs={'class': 'form-control', 'style': 'width:400px', "placeholder": "adcd123@XXX.com"}),
